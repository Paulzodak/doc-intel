  ...
  return (
    <div className="flex h-full min-h-0 flex-col px-3.5 py-4 sm:px-5 sm:py-5 md:px-6 md:py-6">
      <header className="shrink-0">
        <h3 className="mt-0.5 text-center font-brockmann text-base font-bold leading-tight tracking-tight text-[#121714] dark:text-white sm:mt-1 sm:text-lg md:text-xl">
