...
const DocumentInput = () => {
  ...
  return (
    <section className="relative py-12 px-6 md:px-20 lg:px-40 ">
      ...
      <div
        ...
        // }}
      />
      <div className="relative w-[800px] mx-auto space-y-6">
        ...
        <div className="bg-[#1e2939] dasrk:bg-gray-900 rounded-4xl p-8 shadow-lg">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            {/* Left Side */}
            <div>
              <h3 className="text-2xl font-black text-white mb-2">Ready to proceed?</h3>
