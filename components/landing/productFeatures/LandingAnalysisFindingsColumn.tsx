  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-[inherit] p-2.5 sm:p-4">
      ...
      <div className="mb-2 mt-1.5 shrink-0 sm:mb-3 sm:mt-2">
        <p className="text-xs font-lora font-medium text-gray-800 sm:text-sm">
          {landingAnalysisPanelCopy.findingsHeading}
        </p>
      ...
      <div
        className="flex min-h-0 flex-1 flex-col gap-1.5 overflow-y-auto sm:gap-2"
        aria-label="Sample findings"
      >
          ...
          return (
            <button
              ...
              className={clsx(
                ...
                isOn &&
                  "border-primary-green/40 bg-white/55 shadow-md ring-1 ring-primary-green/20",
              )}
            >
              <span
              ...
              <span className="min-w-0 flex-1">
                <span className="block text-[10px] font-bold text-gray-800 sm:text-[11px]">
                  {row.label}
                </span>
